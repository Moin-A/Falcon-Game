...
function initButtons(handleUser, handleSubmit) {
...
async function fetch_result(data) {
...
},{"./utility/helper":"utility/helper.js"}],"Constants.js":[function(require,module,exports) {
"use strict";
...
exports.handleUserFunction = exports.handleSubmit = exports.default = void 0;
...
const gameState = {
  ...
  async handleSubmit() {
    ...
    const data = (0, _helper.Normalize_request_bdy)(Object.values(this.MISSION_PLAN), token);
    let moin = await (0, _helper.fetch_result)(data);
    $(".inherit div.min-h-screen").toggleClass("hidden");
...
async function init() {
  ...
  (0, _initFunc.initButtons)(_gamestate.handleUserFunction, _gamestate.handleSubmit);
