...
function ModifyResultScreen(Search_Outcome) {
  ...
  if (Search_Outcome.status == "success") {
    document.querySelector(".result_screen p").innerHTML = `The Queen was found in ${Search_Outcome.planet_name}`;
  }
...
const gameState = {
  ...
  async handleSubmit() {
    ...
    (0, _helper.ModifyResultScreen)(Search_Outcome);
  },
